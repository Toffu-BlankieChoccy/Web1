...
namespace BaiTap3_63135901.Controllers
{
    public class NhanVien_63135901Controller : Controller
    {
        // GET: NhanVien_63135901
        ...
        public ActionResult Index(HttpPostedFileBase Avatar, EmpModel emp)
        {
           ...
           {emp.EmpID, emp.Name, emp.BirthOfDate.ToShortDateString(),emp.Email,emp.Password,emp.Department, postedFileName};
            ...
            ViewBag.Avatar = "/Pictures/" + emInfo[6];
            return View("Confirm");
        }
